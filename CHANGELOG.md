...
- Bound provider-backed evidence to exact source checkouts, provider-derived job and producer identities, uploaded JUnit digests, and passed test-case selectors.
