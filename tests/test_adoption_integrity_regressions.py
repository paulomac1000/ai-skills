        ...
        "incidents": [
            {
                ...
                "canonical_owner": "skills/example/guide.md#fake-owner",
...
def test_runtime_version_exactness_rejects_moving_tokens_without_substring_false_positives() -> None:
    assert _is_non_exact_version("latest") is True
    assert _is_non_exact_version("1.x") is True
    assert _is_non_exact_version("nightly-20260813") is True
