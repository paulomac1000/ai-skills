...
target_replace_once(
    runtime,
    '''    if effect["lease_required"]:\n        lease = job.get("lease")\n        if not isinstance(lease, dict):\n            reasons.append(("LostAuthority", "lease missing"))\n        else:\n            if lease.get("owner") != authority.get("principal") or authority.get("leaseOwner") != lease.get("owner"):\n                reasons.append(("LostAuthority", "lease owner mismatch"))\n            if lease.get("fencingToken") != authority.get("leaseFencingToken"):\n                reasons.append(("LostAuthority", "lease fencing mismatch"))''',
